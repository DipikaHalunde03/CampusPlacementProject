...
<body>
  ...
  <form action="storestudent.php" method="post"  enctype="multipart/form-data">
    ...
    <input type="text" id="company_name" name="company_name" value="<?php echo isset($_GET['company_name']) ? htmlspecialchars($_GET['company_name']) : 'company_name'; ?>" disabled required>
